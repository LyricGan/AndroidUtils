...
package com.lrc.baseand.view.materialmenu;
...
public abstract class MaterialMenuBase implements MaterialMenu {
	...
	private MaterialMenuDrawable.IconState mCurrentState = MaterialMenuDrawable.IconState.BURGER;
	...
	public MaterialMenuBase(Activity activity, int color, MaterialMenuDrawable.Stroke stroke, int transformDuration, int pressedDuration) {
		mDrawable = new MaterialMenuDrawable(activity, color, stroke, MaterialMenuDrawable.DEFAULT_SCALE, transformDuration, pressedDuration);
	...
	public final void setTransformationOffset(MaterialMenuDrawable.AnimationState animationState, float value) {
		mCurrentState = getDrawable().setTransformationOffset(animationState, value);
	}
	 ...
	 * {@link #animatePressedState(com.ydx.msmtech.materialmenu.MaterialMenuDrawable.IconState)}
	 * 
