...
public class SwipeBackLayout extends FrameLayout {
    ...
    public SwipeBackLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.SwipeBackLayout, defStyle, R.style.SwipeBackLayout);
        int edgeSize = array.getDimensionPixelSize(R.styleable.SwipeBackLayout_edge_size, -1);
        if (edgeSize > 0) {
        	setEdgeSize(edgeSize);
        }
        int mode = EDGE_FLAGS[array.getInt(R.styleable.SwipeBackLayout_edge_flag, 0)];
        setEdgeTrackingEnabled(mode);
        
        int shadowLeft = array.getResourceId(R.styleable.SwipeBackLayout_shadow_left, R.drawable.ic_shadow_left);
        int shadowRight = array.getResourceId(R.styleable.SwipeBackLayout_shadow_right, R.drawable.ic_shadow_right);
        int shadowBottom = array.getResourceId(R.styleable.SwipeBackLayout_shadow_bottom, R.drawable.ic_shadow_bottom);
