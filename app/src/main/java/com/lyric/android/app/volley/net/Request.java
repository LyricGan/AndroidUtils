...
import com.lyric.android.app.volley.net.VolleyLog.MarkerLog;
...
public abstract class Request<T> implements Comparable<Request<T>> {
     ...
     * throw {@link RequestError} as authentication may be required to
     * provide these values.
     * @throws RequestError In the event of auth failure
     */
    public Map<String, String> getHeaders() throws RequestError {
        return Collections.emptyMap();
    }

    /**
     * Returns a Map of parameters to be used for a POST or PUT request.  Can throw
     * {@link RequestError} as authentication may be required to provide these values.
     *
     ...
     * @throws RequestError in the event of auth failure
     */
    public byte[] getBody() throws RequestError {
    ...
    public final void setConnectionTimeoutMs(int connectionTimeoutMs) {
    	this.mConnectionTimeoutMs = connectionTimeoutMs;
    }
     ...
     */
    protected RequestError parseNetworkError(RequestError volleyError) {
        return volleyError;
    }
     ...
     */
    public void deliverError(RequestError error) {
