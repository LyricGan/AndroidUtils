package com.lyric.android.app.third.fresco;
...
public class ImageDraweeView extends SimpleDraweeView {
    ...
    static {
        SMALL_SIZE = DisplayUtils.dip2px(BaseApp.getContext(), 72);
        MIDDLE_SIZE = DisplayUtils.dip2px(BaseApp.getContext(), 144);
        MAX_SIZE = DisplayUtils.dip2px(BaseApp.getContext(), 256);
    }
