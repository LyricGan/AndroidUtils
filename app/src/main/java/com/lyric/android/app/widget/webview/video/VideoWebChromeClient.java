 ...
 * VideoWebChromeClient's onBackPressed() inside of its own
...
public class VideoWebChromeClient extends WebChromeClient
     ...
     * @param webView              The owner VideoWebView. Passing it will enable the
     *                             VideoWebChromeClient to detect the HTML5 video ended
    ...
    public void onShowCustomView(View view, CustomViewCallback callback) {
        if (view instanceof FrameLayout) {
            ...
            if (focusedChild instanceof android.widget.VideoView) {
                ...
                // inherits from android.view.SurfaceView (typically API level 11-18)
                // - android.webkit.HTML5VideoFullScreen$VideoTextureView, which
                // inherits from android.view.TextureView (typically API level 11-18)
                // -
                // com.android.org.chromium.content.browser.ContentVideoView$VideoSurfaceView,
                ...
                if (webView != null && webView.getSettings().getJavaScriptEnabled()
                    ...
                    js += "if (_ytrp_html5_video != undefined && _ytrp_html5_video != _ytrp_html5_video_last) {";
                    {
                        ...
                        js += "function _ytrp_html5_video_ended() {";
                        {
                            ...
                            js += "_VideoWebView.notifyVideoEnd();";
                        }
                        js += "}";
