...
public class GraceRefreshLayout extends RelativeLayout implements PullListener, NestedScrollingChild {
    ...
    private IHeader mHeadView;
    private IFooter mBottomView;
    ...
    protected void onFinishInflate() {
        ...
        coreProcessor.init();
        decorator = new OverScrollDecorator(coreProcessor, new RefreshProcessor(coreProcessor));
        initGestureDetector();
    }
    ...
    public void finishRefreshing() {
        coreProcessor.finishRefreshing();
    }
     ...
     * 设置头部刷新View
     */
    public void setHeaderView(final IHeader headerView) {
        if (headerView != null) {
    ...
    public void addFixedExHeader(final View view) {
        if (view != null && mExtraHeadLayout != null) {
            ...
            coreProcessor.onAddExHead();
            coreProcessor.setExHeadFixed();
        }
    }
     ...
     * 设置底部View
     */
    public void setBottomView(final IFooter bottomView) {
        if (bottomView != null) {
    ...
    public void setMaxHeadHeight(float maxHeightDp) {
        this.mMaxHeadHeight = RefreshUtils.dp2px(getContext(), maxHeightDp);
    }
    ...
    public void setHeaderHeight(float headHeightDp) {
        this.mHeadHeight = RefreshUtils.dp2px(getContext(), headHeightDp);
    }

    public void setMaxBottomHeight(float maxBottomHeight) {
        mMaxBottomHeight = RefreshUtils.dp2px(getContext(), maxBottomHeight);
    }
    ...
    public void setBottomHeight(float bottomHeightDp) {
        this.mBottomHeight = RefreshUtils.dp2px(getContext(), bottomHeightDp);
    }
     ...
     * 是否允许越界时显示头部刷新控件
     */
    public void setOverScrollHeaderShow(boolean isOverScrollTopShow) {
     ...
     * 是否允许越界时显示底部刷新控件
     */
    public void setOverScrollFooterShow(boolean isOverScrollBottomShow) {
        this.isOverScrollBottomShow = isOverScrollBottomShow;
    }

    /**
     * 是否允许越界时显示刷新控件（setOverScrollHeaderShow,setOverScrollBottomShow统一设置方法）
     */
    ...
    public void setOverScrollHeight(float overScrollHeightDp) {
        this.mOverScrollHeight = RefreshUtils.dp2px(getContext(), overScrollHeightDp);
    }
    ...
    public void onFinishLoadMore() {
        ...
        if (!coreProcessor.isEnableKeepIView() && !coreProcessor.isLoadingMore()) {
            return;
        }
    ...
    public class CoreProcessor {
        ...
        public void init() {
            if (isPureScrollModeOn) {
                setOverScrollHeaderShow(false);
                setOverScrollFooterShow(false);
                if (mHeadLayout != null) {
        ...
        public AnimationProcessor getAnimProcessor() {
            ...
            post(new Runnable() {
                ...
                public void run() {
                    ...
                    if (!isPureScrollModeOn && mChildView != null) {
                        setRefreshing(true);
                        animationProcessor.animationHeaderToRefresh();
                    }
                }
            });
        }
        ...
        public void startLoadMore() {
            post(new Runnable() {
                ...
                public void run() {
                    ...
                    if (!isPureScrollModeOn && mChildView != null) {
                        setLoadingMore(true);
                        animationProcessor.animationFooterToLoad();
                    }
                }
            });
        }
        ...
        public void finishRefreshAfterAnimation() {
            if (mChildView != null) {
                animationProcessor.animationHeaderBack(true);
            }
        }
        ...
        public void finishLoadMore() {
            onFinishLoadMore();
            if (mChildView != null) {
                animationProcessor.animationFooterBack(true);
            }
        }
