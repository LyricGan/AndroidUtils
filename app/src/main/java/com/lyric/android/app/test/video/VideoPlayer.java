...
public class VideoPlayer extends FrameLayout implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, SurfaceHolder.Callback, View.OnTouchListener {
    ...
    public static VideoSkin globleSkin;
...
//        surfaceView.setBackgroundColor(R.color.black_a10_color);
     ...
     *
     * @param url         视频地址 | Video address
     * @param thumbUrl       缩略图地址 | Thumbnail address
     * @param title       标题 | title
...
//            surfaceView.setBackgroundColor(R.color.black_a10_color);
    ...
    private void setProgressAndTime(int progress, int currentTime, int totalTime) {
        ...
        tvTimeCurrent.setText(VideoUtils.stringForTime(currentTime));
        tvTimeTotal.setText(VideoUtils.stringForTime(totalTime));
    }
...
//        cancelDismissControlViewTimer();
    ...
    public void setSkin(int titleColor, int timeColor, int seekDrawable, int bottomControlBackground,
        ...
        skin = new VideoSkin(titleColor, timeColor, seekDrawable, bottomControlBackground,
    ...
    public static void setGlobleSkin(int titleColor, int timeColor, int seekDrawable, int bottomControlBackground,
                                     int enlargRecId, int shrinkRecId) {
        globleSkin = new VideoSkin(titleColor, timeColor, seekDrawable, bottomControlBackground,
                enlargRecId, shrinkRecId);
    }

    public static void toFullscreenActivity(Context context, String url, String thumb, String title) {
        VideoFullScreenActivity.toActivity(context, url, thumb, title);
    }
    ...
    private void setSkin(VideoSkin skin) {
