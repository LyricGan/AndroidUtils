...
import com.lyric.android.app.volley.net.core.Network;
...
public class RequestQueue {
    ...
    public RequestQueue(Cache cache, Network network, int threadPoolSize) {
        this(cache, network, threadPoolSize,  new ResponseDelivery(new Handler(Looper.getMainLooper())));
    }
