package com.lyricgan.demo.util.widget.refresh.header;
...
import com.lyricgan.demo.util.widget.refresh.IHeader;
import com.lyricgan.demo.util.widget.refresh.OnAnimationEndListener;
