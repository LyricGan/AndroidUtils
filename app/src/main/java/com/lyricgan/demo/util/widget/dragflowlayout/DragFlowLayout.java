...
public class DragFlowLayout extends FlowLayout implements IViewManager {
    ...
    private AlertWindowHelper mWindowHelper;
    private
    @DragState
    ...
    private void init(Context context, AttributeSet attrs) {
        mWindowHelper = new AlertWindowHelper(context);
    ...
    private void beginDragImpl(View childView) {
        ...
        mWindowHelper.showView(mCallback.createWindowView(childView, mDragState), mTempLocation[0],
    ...
    private boolean processOverlap(View view) {
        ...
        if (found) {
            ...
            mCallback.setWindowViewByChild(mWindowHelper.getView(),
   ...
   /* @Override
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (mDispatchToAlertWindow) {
            mWindowHelper.getView().dispatchTouchEvent(event);
            if (mCancelled) {
                mDispatchToAlertWindow = false;
            }
        }
    ...
    private class GestureListenerImpl extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onDown(MotionEvent e) {
            ...
            mReDrag = false;
            if (mTouchChild != null) {
                mWindowHelper.setTouchDownPosition((int) e.getRawX(), (int) e.getRawY());
