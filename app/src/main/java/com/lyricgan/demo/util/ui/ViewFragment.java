...
import com.lyricgan.demo.util.DemoApplication;
import com.lyricgan.demo.util.R;
import com.lyricgan.demo.util.common.BaseFragment;
import com.lyricgan.util.DisplayUtils;
import com.lyricgan.util.StringUtils;
import com.lyricgan.demo.util.widget.CircleProgressBar;
import com.lyricgan.demo.util.widget.ClashBar;
import com.lyricgan.demo.util.widget.HorizontalRatioBar;
import com.lyricgan.demo.util.widget.PieView;
import com.lyricgan.demo.util.widget.RingProgressBar;
import com.lyricgan.demo.util.widget.layout.TabDigitLayout;
...
public class ViewFragment extends BaseFragment {
    ...
    public void onCreateContentView(View view, Bundle savedInstanceState) {
        ...
        tabDigitLayout.setTextBackground(DisplayUtils.getColor(DemoApplication.getContext(), R.color.color_blue_default));
