package com.lyricgan.demo.util.widget.swipemenu;
...
public class SwipeMenuAdapter implements WrapperListAdapter, SwipeMenuView.OnSwipeItemClickListener {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (mAdapter instanceof BaseSwipListAdapter) {
            boolean enabled = (((BaseSwipListAdapter) mAdapter).isSwipeEnableByPosition(position));
            layout.setSwipEnable(enabled);
        }
        return layout;
    }
