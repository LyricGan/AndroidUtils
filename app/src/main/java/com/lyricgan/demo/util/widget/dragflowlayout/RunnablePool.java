package com.lyricgan.demo.util.widget.dragflowlayout;
 ...
 * the IRunnableExecutor maybe Activity or Fragment . but i have cared about them.
...
public final class RunnablePool {
     ...
     */
    public Runner obtain(IRunnableExecutor executor, int what, Object... params) {
    ...
    public static Runner obtainRunner(IRunnableExecutor executor, int what, Object... params) {
    ...
    public static class Runner implements Runnable {
        ...
        private int what;
        private WeakReference<IRunnableExecutor> mWeakExecutor;

        public void setParams(Object[] mParams) {
            this.mParams = mParams;
        }

        public void setExecutor(IRunnableExecutor mExecutor) {
        ...
        public IRunnableExecutor getExecutor() {
            return mWeakExecutor != null ? mWeakExecutor.get() : mExecutor;
        }

        @Override
        public void run() {
            final IRunnableExecutor executor = getExecutor();
            if (executor == null) {
