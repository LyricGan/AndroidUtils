 ...
 * @date 2015-6-2
 */
public class MediaPlayerControllerVolumeViewBak extends RelativeLayout implements OnClickListener {
    ...
    public MediaPlayerControllerVolumeViewBak(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context);
    }

    public MediaPlayerControllerVolumeViewBak(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public MediaPlayerControllerVolumeViewBak(Context context) {
        super(context);
        init(context);
    }
