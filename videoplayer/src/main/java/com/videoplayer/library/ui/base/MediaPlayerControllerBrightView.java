...
public class MediaPlayerControllerBrightView extends RelativeLayout {
    ...
    public MediaPlayerControllerBrightView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void init(final Context context) {
        ...
        View root = LayoutInflater.from(context).inflate(R.layout.blue_media_player_controller_bright_view, this);

        mSeekBrightProgress = (MediaPlayerBrightSeekBar) root.findViewById(R.id.seekbar_bright_progress);

        // 进度条绑定最大亮度，255是最大亮度
        mSeekBrightProgress.setMax(MAX_BRIGNTNESS);
        // 取得当前亮度
        int normal = Settings.System.getInt(context.getContentResolver(), Settings.System.SCREEN_BRIGHTNESS, MAX_BRIGNTNESS);
