...
public abstract class MediaPlayerBaseControllerView extends FrameLayout {
    ...
    protected VideoMediaPlayerView.PlayerViewCallback mPlayerViewCallback;
    ...
    public void setPlayerViewCallback(VideoMediaPlayerView.PlayerViewCallback callback) {
