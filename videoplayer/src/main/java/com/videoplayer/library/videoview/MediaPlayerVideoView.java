...
public class MediaPlayerVideoView extends SurfaceView implements MediaPlayerControl, IPowerStateListener {
    ...
    private void openVideo() {
        ...
        try {
            ...
            if (mMediaPlayerPlus != null) {
                mMediaPlayerPlus.onVideoPreparing();
            }
    ...
    OnPreparedListener mPreparedListener = new OnPreparedListener() {
        ...
        public void onPrepared(MediaPlayer mp) {
            Log.e(Constants.LOG_TAG, "onPrepared: --------------------------" );
    ...
    SurfaceHolder.Callback mSHCallback = new SurfaceHolder.Callback() {
        ...
        public void surfaceCreated(SurfaceHolder holder) {
            ...
            switch (mPlayConfig.getInterruptMode()) {
                case PlayConfig.INTERRUPT_MODE_RELEASE_CREATE:
                    Log.e(Constants.LOG_TAG, "surfaceCreated()---PlayConfig.INTERRUPT_MODE_RELEASE_CREATE");
                    openVideo();
                    break;
                case PlayConfig.INTERRUPT_MODE_PAUSE_RESUME:{
                    Log.e(Constants.LOG_TAG, "surfaceCreated()---PlayConfig.INTERRUPT_MODE_PAUSE_RESUME");
                    if (mMediaPlayer != null) {
                ...
                case PlayConfig.INTERRUPT_MODE_FINISH: {
                    Log.e(Constants.LOG_TAG, "surfaceCreated()---PlayConfig.INTERRUPT_MODE_FINISH");
                    if (mMediaPlayer != null) {
                        mMediaPlayer.setSurface(mSurfaceHolder.getSurface());
                    }
                }
                ...
                case PlayConfig.INTERRUPT_MODE_ERROR: {
                    Log.e(Constants.LOG_TAG, "surfaceCreated()---PlayConfig.INTERRUPT_MODE_ERROR");
                    if (mMediaPlayer != null) {
                        mMediaPlayer.setSurface(mSurfaceHolder.getSurface());
                        if (!mNeedPauseAfterLeave) {
                            start();
        ...
        public void surfaceDestroyed(SurfaceHolder holder) {
            ...
            switch (mPlayConfig.getInterruptMode()) {
                case PlayConfig.INTERRUPT_MODE_RELEASE_CREATE:
                    Log.e(Constants.LOG_TAG, "surfaceDestroyed()---PlayConfig.INTERRUPT_MODE_RELEASE_CREATE");
                    release(true);
                    break;
                case PlayConfig.INTERRUPT_MODE_PAUSE_RESUME:
                    Log.e(Constants.LOG_TAG, "surfaceDestroyed()---PlayConfig.INTERRUPT_MODE_PAUSE_RESUME");
                    pause();
                    break;
                case PlayConfig.INTERRUPT_MODE_FINISH:
                    Log.e(Constants.LOG_TAG, "surfaceDestroyed()---PlayConfig.INTERRUPT_MODE_FINISH");
                    break;
                case PlayConfig.INTERRUPT_MODE_ERROR:
                    Log.e(Constants.LOG_TAG, "surfaceDestroyed()---PlayConfig.INTERRUPT_MODE_ERROR");
                    break;
            }
        }
    };
    ...
    public void seekTo(int pos) {
        Log.e(Constants.LOG_TAG, "seekTo()---pos:" + pos);
        if (isInPlaybackState()) {
    ...
    public void onPowerState(int state) {
        switch (state) {
            case Constants.POWER_OFF:
                ...
                switch (mPlayConfig.getInterruptMode()) {
                    case PlayConfig.INTERRUPT_MODE_RELEASE_CREATE:
                        Log.e(Constants.LOG_TAG, " onPowerState()---INTERRUPT_MODE_RELEASE_CREATE");
                        release(true);
                        break;
                    case PlayConfig.INTERRUPT_MODE_PAUSE_RESUME:
                        Log.e(Constants.LOG_TAG, " onPowerState()---INTERRUPT_MODE_PAUSE_RESUME");
                        pause();
                        break;
                    case PlayConfig.INTERRUPT_MODE_FINISH:
                        Log.e(Constants.LOG_TAG, " onPowerState()---INTERRUPT_MODE_FINISH");
                        break;
                    case PlayConfig.INTERRUPT_MODE_ERROR:
                        Log.e(Constants.LOG_TAG, " onPowerState()---INTERRUPT_MODE_ERROR");
                        break;
                }
                break;
    ...
    private void videoResumeWithoutUnlock() {
        switch (mPlayConfig.getInterruptMode()) {
            case PlayConfig.INTERRUPT_MODE_RELEASE_CREATE:
                Log.e(Constants.LOG_TAG, " videoResumeWithoutUnlock()---PlayConfig.INTERRUPT_MODE_RELEASE_CREATE");
                openVideo();
                break;
            case PlayConfig.INTERRUPT_MODE_PAUSE_RESUME:
                Log.e(Constants.LOG_TAG, " videoResumeWithoutUnlock()---PlayConfig.INTERRUPT_MODE_PAUSE_RESUME");
                stopMusicService();
                if (!mNeedPauseAfterLeave) {
                    start();
                } else {
                ...
                break;
            case PlayConfig.INTERRUPT_MODE_FINISH:
                Log.e(Constants.LOG_TAG, " videoResumeWithoutUnlock()---PlayConfig.INTERRUPT_MODE_FINISH");
                break;
            case PlayConfig.INTERRUPT_MODE_ERROR:
                Log.e(Constants.LOG_TAG, " videoResumeWithoutUnlock()---PlayConfig.INTERRUPT_MODE_ERROR");
                break;
        }
    }
        ...
        if (mNeedUnlock) {
            ...
            switch (mPlayConfig.getInterruptMode()) {
                ...
                case PlayConfig.INTERRUPT_MODE_PAUSE_RESUME:
                    ...
                    break;
                case PlayConfig.INTERRUPT_MODE_FINISH:
                    Log.e(Constants.LOG_TAG, " videoResumeWithUnlock()---PlayConfig.INTERRUPT_MODE_FINISH");
                    mMediaPlayer.setSurface(mSurfaceHolder.getSurface());
                    break;
                case PlayConfig.INTERRUPT_MODE_ERROR:
                    Log.e(Constants.LOG_TAG, " videoResumeWithUnlock()---PlayConfig.INTERRUPT_MODE_ERROR");
                    mMediaPlayer.setSurface(mSurfaceHolder.getSurface());
                    break;
            }
        }
