 ...
 * @author Orhan Obut
 */
final class LoggerImpl implements ILogger {
    /**
     ...
     */
    private static String TAG = "LOGGER_HELPER";
    /**
    ...
    @Override
    public ILogger t(String tag, int methodCount) {
        if (tag != null) {
            LOCAL_TAG.set(tag);
        }
    ...
    private void logHeaderContent(int logType, String tag, int methodCount) {
        ...
        if (LOGGER_SETTINGS.isShowThreadInfo()) {
    ...
    private int getMethodCount() {
        ...
        int result = LOGGER_SETTINGS.getMethodCount();
        if (count != null) {
