...
import com.bigkoo.pickerview.WheelAdapter;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.wheelview, 0, 0);
            try {
                mGravity = array.getInt(R.styleable.wheelview_gravity, Gravity.CENTER);
                textColorOut = array.getColor(R.styleable.wheelview_textColorOut, textColorOut);
                textColorCenter = array.getColor(R.styleable.wheelview_textColorCenter, textColorCenter);
                dividerColor = array.getColor(R.styleable.wheelview_dividerColorPicker, dividerColor);
                textSize = array.getDimensionPixelOffset(R.styleable.wheelview_textSizePicker, textSize);
            } finally {
                array.recycle();
            }
        }
