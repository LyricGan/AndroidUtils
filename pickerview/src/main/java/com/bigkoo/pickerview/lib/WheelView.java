...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        if(attrs != null) {
            ...
            dividerColor = a.getColor(R.styleable.wheelview_dividerColorPicker,dividerColor);
            textSize = a.getDimensionPixelOffset(R.styleable.wheelview_textSizePicker,textSize);
        }
