...
public class FloatingLabelView extends LinearLayout implements OnFocusChangeListener {
	...
	private void createLayout(AttributeSet attrs) {
		...
		inpuTextParams = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT);
		displayTextParams = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT);
