...
public class MyListViewFooter extends LinearLayout {
	...
	private void initView(Context context) {
		...
		view_list_view_footer.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT));
	...
	public void setBottomMargin(int height) {
		...
		LayoutParams layoutParams = (LayoutParams) view_list_footer.getLayoutParams();
