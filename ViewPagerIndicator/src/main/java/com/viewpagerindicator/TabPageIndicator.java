...
public class TabPageIndicator extends HorizontalScrollView implements PageIndicator {
    ...
    public class TabView extends FrameLayout {
        ...
        public TabView(Context context) {
            ...
            LayoutParams params = new FrameLayout.LayoutParams(FrameLayout.LayoutParams.WRAP_CONTENT, FrameLayout.LayoutParams.WRAP_CONTENT);
            ...
            mTextView.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                ...
                public void onGlobalLayout() {
                    ...
                    LayoutParams paramsRedPoint = new FrameLayout.LayoutParams(width, width);
                    paramsRedPoint.gravity = Gravity.RIGHT;
                    paramsRedPoint.setMargins(0, mTextView.getTop() + mTextView.getPaddingTop(), maginRight, 0);
