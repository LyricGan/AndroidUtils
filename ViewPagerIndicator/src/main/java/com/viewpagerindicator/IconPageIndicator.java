...
public class IconPageIndicator extends HorizontalScrollView implements PageIndicator {
    ...
    public void notifyDataSetChanged() {
        ...
        if(mAdapterCount <= 0){
            mAdapterCount = iconAdapter.getCount();
        }
        ...
        if (mSelectedIndex > mAdapterCount) {
            mSelectedIndex = mAdapterCount - 1;
        }
    ...
    public void setCurrentItem(int item) {
        ...
        mSelectedIndex = item;
        if(item >= mAdapterCount){
            mSelectedIndex = item % mAdapterCount;
        }
    ...
    public void setAdapterCount(int adapterCount) {
        this.mAdapterCount = adapterCount;
    }
}
